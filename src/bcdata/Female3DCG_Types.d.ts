...
declare namespace TopLeft {
     ...
     */
    type Data = Readonly<
        Partial<Record<AssetPoseName, number>> & Record<PoseTypeDefault, number>
    >;
    /**
    ...
    type Definition =
        | number
        | Partial<Record<AssetPoseName | PoseTypeDefault, number>>;
}
...
declare namespace Alpha {
    ...
    interface Data {
         ...
         */
        readonly Pose: null | Readonly<
            Partial<Record<AssetPoseCategory, readonly AssetPoseName[]>>
        >;
    }
...
declare namespace ParentGroup {
    ...
    type Data = Partial<
        Record<
            PoseTypeDefault | AssetPoseName,
            PoseTypeDefault | AssetGroupName
        >
    >;
...
interface AssetGroupDefinitionBase
    extends AssetCommonPropertiesGroupAsset,
...
interface AssetLayerDefinition
    extends AssetCommonPropertiesGroupAssetLayer,
        AssetCommonPropertiesAssetLayer {
    /** The layer's name */
    Name?: string;
 ...
 */
type ExtendedItemMainConfig = Partial<
    Record<AssetGroupName, ExtendedItemGroupConfig>
>;
...
interface ExtendedItemOption
    extends Omit<ExtendedItemOptionConfig, "ArchetypeConfig"> {
    /**
...
interface TypedItemOption
    extends Omit<TypedItemOptionConfig, "ArchetypeConfig">,
        ExtendedItemOption {
...
interface TypedItemConfig extends ExtendedItemConfig<TypedItemOption> {
     ...
     * Note that scripthook functions must be loaded before `Female3DCGExtended.js` in `index.html`.
     */
    ScriptHooks?: ExtendedItemCapsScriptHooksStruct<
        TypedItemData,
        TypedItemOption
    >;
...
interface ModularItemOptionConfig
    extends Omit<ExtendedItemOptionConfig, "Name"> {
...
interface ModularItemOption
    extends Omit<ModularItemOptionConfig, "ArchetypeConfig">,
...
interface VibratingItemOptionConfig extends ExtendedItemOptionConfig {
    Name: VibratorMode;
    Property: ItemProperties &
        Pick<Required<ItemProperties>, "Intensity" | "Effect"> &
        Omit<ItemProperties, "TypeRecord">;
...
interface VibratingItemOption
    extends Omit<VibratingItemOptionConfig, "ArchetypeConfig">,
        Omit<ExtendedItemOption, "Name" | "Property"> {
...
interface VariableHeightConfig
    extends ExtendedItemConfig<VariableHeightOption> {
