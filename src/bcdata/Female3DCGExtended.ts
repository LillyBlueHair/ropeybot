...
export var AssetFemale3DCGExtended = {
            ...
            DialogPrefix: {
                ...
                Chat: ({ C }) =>
                    `ItemArmsCeilingShacklesSet${
                        C.PoseMapping.BodyFull === "Suspension"
                            ? "Suspension"
                            : ""
                    }`,
            },
        ...
        StraitLeotard: {
            ...
            Modules: [
                ...
                },
                {
                    ...
                    Key: "co",
                    Options: [
                        { Property: { Hide: ["Corset", "ItemTorso"] } },
                        {},
                    ],
                },
                {
    ...
    ItemDevices: {
        ...
        Locker: {
            ...
            DialogPrefix: {
                Npc: (C, Option, PreviousOption) =>
                    `ItemDevicesLocker${Option.Name}`,
            },
        }, // Locker
        SmallLocker: {
            Archetype: ExtendedArchetype.TYPED,
    ...
    HairAccessory1: {
        ...
        Halo: {
            ...
            ScriptHooks: {
                ...
                Draw: (...args) =>
                    PropertyOpacityDraw(...args, 0, -50, "Brightness"),
                Exit: PropertyOpacityExit,
            },
            BaselineProperty: { Opacity: 0 },
        }, // Halo
            ...
            Modules: [
                ...
                },
                {
                    ...
                    Options: [
                        ...
                        {
                            Property: {
                                Effect: [E.BlockMouth, E.GagVeryLight],
                            },
                        },
                        { Property: { Effect: [] } },
